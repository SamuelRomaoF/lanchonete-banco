...
export type OrderStatus = "pendente" | "confirmado" | "preparo" | "pronto" | "entrega" | "concluido" | "cancelado";
...
export const orderSchema = z.object({
  ...
  status: z.enum(["pendente", "confirmado", "preparo", "pronto", "entrega", "concluido", "cancelado"]).default("pendente"),
